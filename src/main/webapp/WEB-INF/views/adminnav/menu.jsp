...
<hr>
        ...
        <div class="menu">
            ...
            <ul>
                <li class="regular"><a href='${pageContext.request.contextPath}/user/list.do'>회원 관리</a></li>
                <li class="regular"><a href='${pageContext.request.contextPath}/bbs/list.do'>주문 현황</a></li>
                <li class="regular"><a href='${pageContext.request.contextPath}/prod/list.do'>상품관리</a></li>
            </ul>
        </div>
</header>        
</body>
