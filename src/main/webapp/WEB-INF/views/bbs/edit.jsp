...
<body>
    ...
    <div class="container">
        ...
        <!-- 폼 영역 -->
        <div class="form">
            <form action="${pageContext.request.contextPath}/bbs/edit.do" method="post" enctype="multipart/form-data">
                <table>
                    <!-- 게시물 번호 -->
                    <tr>
                        <th>게시물 번호</th>
                        <td>
                            <input type="text" name="BbsNo" value="${fn:escapeXml(editform.bbsNo)}" readonly="readonly">
                        </td>
                    </tr>
                    <!-- 아이디 -->
                    <tr>
                        <th>아이디</th>
                        <td>
                            <input type="text" name="BbsId" value="${fn:escapeXml(editform.bbsId)}" readonly="readonly">
                        </td>
                    </tr>
                    <!-- 제목 -->
                    <tr>
                        <th>제목</th>
                        <td>
                            <input type="text" name="BbsTitle" value="${fn:escapeXml(editform.bbsTitle)}">
                        </td>
                    </tr>
                    <!-- 내용 -->
                    <tr>
                        <th>내용</th>
                        <td>
                            <textarea id="BbsCon" name="BbsCon" rows="20" cols="80">${fn:escapeXml(editform.bbsCon)}</textarea>
                        </td>
                    </tr>
                    <!-- 기존 첨부파일 삭제 -->
                    <tr>
                        ...
                        <td>
                            <c:forEach var="attach" items="${attinfo}">
                                <div class="file-input">
                                    <input type="checkbox" name="deleteAttIds" value="${attach.attNo}"> <!-- 삭제 체크박스 -->
                                    <span>(삭제할 파일 클릭) ${fn:escapeXml(attach.attName)}</span>
                                </div>
                            </c:forEach>
                        </td>
                    </tr>
