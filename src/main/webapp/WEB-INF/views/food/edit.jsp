...
<body>
    ...
    <div class="container">
        ...
        <!-- 폼 영역 -->
        <div class="form">
            <form action="${pageContext.request.contextPath}/food/edit.do" method="post" enctype="multipart/form-data">
                <table>
                    <!-- 게시물 번호 -->
                    <tr>
                        <th>게시물 번호</th>
                        <td>
                            <input type="text" name="foodBbsNo" value="${fn:escapeXml(editform.foodBbsNo)}" readonly="readonly">
                        </td>
                    </tr>
                    <!-- 아이디 -->
                    <tr>
                        <th>아이디</th>
                        <td>
                            <input type="text" name="foodBbsId" value="${fn:escapeXml(editform.foodBbsId)}" readonly="readonly">
                        </td>
                    </tr>
                    <!-- 제목 -->
                    <tr>
                        <th>제목</th>
                        <td>
                            <input type="text" name="foodBbsTitle" value="${fn:escapeXml(editform.foodBbsTitle)}">
                        </td>
                    </tr>
                    <!-- 내용 -->
                    <tr>
                        <th>내용</th>
                        <td>
                            <textarea id="BbsCon" name="foodBbsCon" rows="20" cols="80">${fn:escapeXml(editform.foodBbsCon)}</textarea>
                        </td>
                    </tr>
                    <!-- 기존 첨부파일 삭제 -->
                    <tr>
                        ...
                        <td>
                            <c:forEach var="attach" items="${attinfo}">
                                <div class="file-input">
                                    <input type="checkbox" name="deleteAttIds" value="${attach.foodAttNo}"> <!-- 삭제 체크박스 -->
                                    <span>(삭제할 파일 클릭) ${fn:escapeXml(attach.foodAttName)}</span>
                                </div>
                            </c:forEach>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th>새로운 첨부파일 추가</th>
                        <td>
                            <input type="file" name="upfilelist" multiple> <!-- 여러 파일 업로드 가능 -->
                        </td>
                    </tr>
                </table>
                <!-- 제출 버튼 -->
            ...
            <!-- 목록으로 버튼 -->
            <a href="${pageContext.request.contextPath}/food/list.do">
