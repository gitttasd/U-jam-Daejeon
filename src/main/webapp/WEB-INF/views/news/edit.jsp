...
<body>
    ...
    <div class="container">
        ...
        <!-- 폼 영역 -->
        <div class="form">
            <form action="${pageContext.request.contextPath}/news/edit.do" method="post">
                <table>
                    <!-- 게시물 번호 -->
                    <tr>
                        <th>게시물 번호</th>
                        <td>
                            <input type="text" name="newsBbsNo" value="${fn:escapeXml(editform.newsBbsNo)}" readonly="readonly">
                        </td>
                    </tr>
                    <!-- 아이디 -->
                    <tr>
                        <th>아이디</th>
                        <td>
                            <input type="text" name="newsBbsId" value="${fn:escapeXml(editform.newsBbsId)}" readonly="readonly">
                        </td>
                    </tr>
                    <!-- 제목 -->
                    <tr>
                        <th>제목</th>
                        <td>
                            <input type="text" name="newsBbsTitle" value="${fn:escapeXml(editform.newsBbsTitle)}">
                        </td>
                    </tr>
                    <!-- 내용 -->
                    <tr>
                        <th>내용</th>
                        <td>
                            <textarea id="BbsCon" name="newsBbsCon" rows="20" cols="80">${fn:escapeXml(editform.newsBbsCon)}</textarea>
                        </td>
                    </tr>
                </table>
                <!-- 제출 버튼 -->
