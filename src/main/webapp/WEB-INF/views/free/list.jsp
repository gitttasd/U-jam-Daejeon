...
<body>
  ...
  <div class="layout">
    ...
    <div class="content">
      ...
      <div id="addbutton">
        <!-- 게시글 작성 버튼 -->
        <a href='${pageContext.request.contextPath}/free/add.do?freeBbsid=${bbs.freeBbsId}'><button type="button" class="btn btn-primary">
      ...
      <table>
        ...
        <tbody>
          ...
          <c:forEach items="${pagination}" var="bbs">
            <tr>
              <td>${bbs.freeBbsNo}</td>
              <td><a href='${pageContext.request.contextPath}/free/select.do?freeBbsNo=${bbs.freeBbsNo}'>${bbs.freeBbsTitle}</a></td>
              <td>${bbs.freeBbsId}</td>
              <td>${bbs.freeBbsUser}</td>
              <td>${bbs.freeBbsRegdate}</td>
              <td>${bbs.freeBbsCnt}</td> 
            </tr>
          </c:forEach>
        </tbody>
      </table>
          ...
          <ul class="pagination">
            ...
            <li class="page-item">
              <c:choose>
                <c:when test="${currentPage > 1}">
                  <a class="page-link" href="${pageContext.request.contextPath}/free/list.do?page=${currentPage - 1}&size=${pageSize}" aria-label="Previous">
            ...
            <c:forEach begin="1" end="${totalPages}" var="i">
              <c:choose>
                ...
                <c:otherwise>
                  <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/free/list.do?page=${i}&size=${pageSize}">${i}</a></li>
                </c:otherwise>
              </c:choose>
            </c:forEach>
            ...
            <li class="page-item">
              <c:choose>
                <c:when test="${currentPage < totalPages}">
                  <a class="page-link" href="${pageContext.request.contextPath}/free/list.do?page=${currentPage + 1}&size=${pageSize}" aria-label="Next">
