...
<body>
    ...
    <div class="container">
        ...
        <!-- 폼 영역 -->
        <div class="form">
            <form action="${pageContext.request.contextPath}/free/edit.do" method="post">
                <table>
                    <!-- 게시물 번호 -->
                    <tr>
                        <th>게시물 번호</th>
                        <td>
                            <input type="text" name="freeBbsNo" value="${fn:escapeXml(editform.freeBbsNo)}" readonly="readonly">
                        </td>
                    </tr>
                    <!-- 아이디 -->
                    <tr>
                        <th>아이디</th>
                        <td>
                            <input type="text" name="freeBbsId" value="${fn:escapeXml(editform.freeBbsId)}" readonly="readonly">
                        </td>
                    </tr>
                    <!-- 제목 -->
                    <tr>
                        <th>제목</th>
                        <td>
                            <input type="text" name="freeBbsTitle" value="${fn:escapeXml(editform.freeBbsTitle)}">
                        </td>
                    </tr>
                    <!-- 내용 -->
                    <tr>
                        <th>내용</th>
                        <td>
                            <textarea id="BbsCon" name="freeBbsCon" rows="20" cols="80">${fn:escapeXml(editform.freeBbsCon)}</textarea>
                        </td>
                    </tr>
                </table>
                <!-- 제출 버튼 -->
