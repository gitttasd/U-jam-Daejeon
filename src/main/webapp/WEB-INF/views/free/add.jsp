...
<hr>
	...
	<div class="form">
    <form action="${pageContext.request.contextPath}/free/add.do" enctype="multipart/form-data"  method="post">
        <table>
            <tr>
                <th>제목</th>
                <td><input type="text" name="freeBbsTitle"></td>
            </tr>
            <tr>
                <th>아이디</th>
                <td>${loginUser.id}</td>
            ...
            <tr>
                <th>내용</th>
                <td><textarea id="BbsCon" name="freeBbsCon" rows="20" cols="60"></textarea></td>
            </tr>
     <!--        <tr>
            	<th>첨부파일</th>
